...
- (void)setupImageView
{
    ...
    self.imageView.backgroundColor = BACKGROUND_COLOR;
...
//    UILabel *backLable = [[UILabel alloc]initWithFrame:CGRectMake(30, 31, 42, 22)];
//    backLable.font = kFontSizeBig;
//    [backLable setText:@"返回"];
//    [backLable setTextColor:[UIColor whiteColor]];
//    [_navBarView addSubview:backLable];
