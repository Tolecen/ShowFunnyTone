...
@interface SubjectViewController : BabyBaseVC<UIWebViewDelegate>

/**
 Initializes a new `SubjectViewController` object with the specified URL.
 
 @param url The URL to the web page that the controller will initially display.
 
 @return The newly initialized `SubjectViewController` object.
 */
- (instancetype)initWithURL:(NSURL *)url;

/**
 Initializes a new `SubjectViewController` object with the specified URL string.
...
@property (nonatomic,strong)    UIColor *buttonBottomTintColor;
...
@property(nonatomic, strong) SubjectInfo *mSubjectInfo;
