...
- (void)configCollectionView {
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(_margin, 0, SCREEN_WIDTH - 2 * _margin, SCREEN_HEIGHT - 50 - 40) collectionViewLayout:_layout];
    ...
    startBtn.frame = CGRectMake(_margin, SCREEN_HEIGHT - 48, SCREEN_WIDTH - 2 * _margin, 46);
    startBtn.titleLabel.font = kFontSizeBig;
    startBtn.enabled = NO;
    [self.view addSubview:startBtn];
    _startBtn = startBtn;
    
    UILabel *startTips = [[UILabel alloc]initWithFrame:CGRectMake(_margin, SCREEN_HEIGHT - 50 - 36, SCREEN_WIDTH - 2* _margin, 36)];
